        ...
        <div class="box">
            <div class="box-header">
                <div style="padding: 20px">
                    <a href="{{$new}}" class="btn btn-primary">Tambah Data Pendidiakan</a>  
                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                @include('layouts.notifikasi')
                <table {{{ $pendidikanCount > 0 ? "id='tblPendidikan'" : '' }}} class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
