        ...
        <div class="box">
            <div class="box-header">
                <div style="padding: 20px">
                    <a href="{{$new}}" class="btn btn-primary">Tambah Data Pekerjaan</a>  
                </div>
            </div><!-- /.box-header -->
            <div class="box-body table-responsive">
                @include('layouts.notifikasi')
                <table {{{ $pekerjaanCount > 0 ? "id='tblPekerjaan'" : '' }}} class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
